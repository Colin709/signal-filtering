...
classdef filter_class
    ...
    methods(Static)
        ...
        %         function MinOrder_iir_filter = MinOrder_iir_filterDesign(MinOrder_filter_in)
        %             %MINORDER_iir_FILTERDESIGN - creates a min order iir filter
        %
        %             if  strcmp(MinOrder_filter_in.response,'lowpass')
        %                 MinOrder_iir_filter = designfilt('lowpassiir', ...
        %                     'PassbandFrequency',MinOrder_filter_in.cutoff_frequency, ...
        %                     'StopbandFrequency',MinOrder_filter_in.cutoff_frequency+100, ...
        %                     'StopbandAttenuation',...
        %                     'PassbandRipple',...
        %                     'DesignMethod',MinOrder_filter_in.design_method,...
        %                     'MatchExactly',...
        %                     'SampleRate',filter_in.SampleRate);
        %             elseif strcmp(MinOrder_filter_in.response,'highpass')
        %                 MinOrder_iir_filter = designfilt('highpassiir', ...
        %                     'FilterOrder',MinOrder_filter_in.the_order, ...
        %                     'PassbandFrequency',MinOrder_filter_in.cutoff_frequency, ...
        %                     'StopbandFrequency',MinOrder_filter_in.cutoff_frequency+100, ...
        %                     'StopbandAttenuation',...
        %                     'PassbandRipple',...
        ...
        %                     'MatchExactly',...
        %                     'SampleRate',filter_in.SampleRate);
        %             elseif strcmp(MinOrder_filter_in.response,'bandpass')
        %                 MinOrder_iir_filter = designfilt('bandpassiir', ...
        %                     'PassbandFrequency1',MinOrder_filter_in.cutoff_frequency, ...
        %                     'StopbandFrequency1',MinOrder_filter_in.cutoff_frequency-100, ...
        %                     'PassbandFrequency2',MinOrder_filter_in.cutoff_frequency+100, ...
        %                     'StopbandFrequency2',MinOrder_filter_in.cutoff_frequency+200, ...
        %                     'StopbandAttenuation',...
        %                     'PassbandRipple',...
        %                     'StopbandAttenuation2',...
        %                     'DesignMethod',MinOrder_filter_in.design_method,...
        %                     'SampleRate',filter_in.SampleRate);
        %             elseif strcmp(MinOrder_filter_in.response,'bandstop')
        %                 MinOrder_iir_filter = designfilt('bandstopiir', ...
        %                     'PassbandFrequency1',MinOrder_filter_in.cutoff_frequency, ...
        %                     'StopbandFrequency1',MinOrder_filter_in.cutoff_frequency-100, ...
        %                     'PassbandFrequency2',MinOrder_filter_in.cutoff_frequency+100, ...
        %                     'StopbandFrequency2',MinOrder_filter_in.cutoff_frequency+200, ...
...
%         function designed_MinOrder_filter = MinOrderDesign(filter_MinOrder)
%             % DESIGNED_MINODER_FILTER - design either fir or iir minorder filter
%             if strcmp(filter_MinOrder.iir_fir,'fir')
%                 designed_MinOrder_filter = ...
%                     filter_class.fir_filterDesign(filter_MinOrder);
%             elseif strcmp(filter_MinOrder.iir_fir,'iir')
%                 designed_MinOrder_filter = ...
%                     filter_class.MinOrder_iir_filterDesign(filter_MinOrder);
%             else
